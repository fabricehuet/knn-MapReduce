...
#-------------------------------------------------------------------------------
matrices=[]
tab = ["hbnlj","hvknnj","hzknnj","hlsh","hlsh_good_accurancy"] 
tab = ["hbnlj","hvknnj","hzknnj","hlsh"] 
tab2 = ["hbnlj","pgbj","hzknnj","rankreduce"] 

for i in tab :
    label,mat = file2matrix(path+i,3,';')
    matrices.append(mat)
...
fig.suptitle("Impact K on time and accurancy for 4000 data",fontsize=14, 
             fontweight='bold')
...
show()
fig.savefig('../../graph/geo/K.png',dpi=400)
